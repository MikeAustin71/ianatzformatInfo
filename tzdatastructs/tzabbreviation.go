...
var TzAbbreviationReference = map[string]TzAbbreviationDto{
	...
	"A+0100"      :{"A+0100","A","Alpha","Military","+0100","Etc/GMT-1"},
	...
	"B+0200"      :{"B+0200","B","Bravo","Military","+0200","Etc/GMT-2"},
	...
	"C+0300"      :{"C+0300","C","Charlie","Military","+0300","Etc/GMT-3"},
	...
	"D+0400"      :{"D+0400","D","Delta","Military","+0400","Etc/GMT-4"},
	"DAVT+0700"     :{"DAVT+0700","DAVT","Davis Time","Antarctica","+0700",""},
	"E+0500"        :{"E+0500","E","Echo","Military","+0500","Etc/GMT-5"},
	...
	"F+0600"        :{"F+0600","F","Foxtrot","Military","+0600","Etc/GMT-6"},
	...
	"G+0700"        :{"G+0700","G","Golf","Military","+0700","Etc/GMT-7"},
	...
	"H+0800"      :{"H+0800","H","Hotel","Military","+0800","Etc/GMT-8"},
	...
	"I+0900"      :{"I+0900","I","India","Military","+0900","Etc/GMT-9"},
	...
	"K+1000"        :{"K+1000","K","Kilo Time Zone","Military","+1000","Etc/GMT-10"},
	...
	"L+1100"        :{"L+1100","L","Lima","Military","+1100", "Etc/GMT-11"},
	...
	"M+1200"        :{"M+1200","M","Mike","Military","+1200","Etc/GMT-12"},
	...
	"N-0100"        :{"N-0100","N","November","Military","-0100","Etc/GMT+1"},
	...
	"Q-0400"        :{"Q-0400","Q","Quebec","Military","-0400","Etc/GMT+4"},
	"R-0500"        :{"R-0500","R","Romeo","Military","-0500","Etc/GMT+5"},
	"RET+0400"      :{"RET+0400","RET","Reunion Time","Africa","+0400",""},
	"S-0600"        :{"S-0600","S","Sierra","Military","-0600","Etc/GMT+6"},
	...
	"T-0700"        :{"T-0700","T","Tango","Military","-0700","Etc/GMT+7"},
	...
	"U-0800"        :{"U-0800","U","Uniform","Military","-0800","Etc/GMT+8"},
	...
	"V-0900"        :{"V-0900","V","Victor","Military","-0900","Etc/GMT+9"},
	...
	"W-1000"        :{"W-1000","W","Whiskey","Military","-1000","Etc/GMT+10"},
	...
	"X-1100"        :{"X-1100","X","X-ray","Military","-1100","Etc/GMT+11"},
	"Y-1200"        :{"Y-1200","Y","Yankee","Military","-1200","Etc/GMT+12"},
	...
	"Z+0000"      :{"Z+0000","Z","Zulu Time Zone","Military","+0000","UTC"},
}
